    ...
    for i in range(len(BODY_PARTS)):
        ...
        if prob > threshold:  # [pointed]
            ...
            if picturetype == "side":
                ...
                # Shoulder
                if (i == 2):
                    global front_Rshoulderx, front_Rshouldery
                    front_Rshoulderx = x
                    front_Rshouldery = y
                
                    cv2.circle(frame, (x, y), 5, (0, 255, 255), thickness=-1, lineType=cv2.FILLED)
                elif (i == 5):
                    global front_Lshoulderx, front_Lshouldery
                    front_Lshoulderx = x
                    front_Lshouldery = y
                ...
                # Hip
                    ...
                    global front_Rhipx, front_Rhipy
                    front_Rhipx = x
                    front_Rhipy = y
                    ...
                    global front_Lhipx, front_Lhipy
                    front_Lhipx = x
                    front_Lhipy = y
...
print(f"discValue: {discValue}°")
print(f"discCheck: {discCheck}")
print(f"shoulderAngle: {shoulderAngle}°")
print(f"hipAngle: {hipAngle}°")
